...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Tz5UkASZ#7ZbY9A-z9PGfIzAIs0omxr_9VqdPVXfQQrmjPUdV_Cg", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
PACK_AUTHOR: process.env.PACK_AUTHOR || "BVN", // Added // Input Yours custom...
...
AUTO_REACT: process.env.AUTO_REACT || "true6",
